      ...
      <div class="w-full h-[100vh] border-r">
        <div class="fixed left-0 top-0 w-[58px] h-full bg-white">
            <nav class="grid gap-1 px-4">
              <a class="text-center text-base text-black hover:text-black hover:bg-slate-100 py-2
                 href={"/"}
              >{"Bing"}</a>
              <a class="text-center text-base text-black hover:text-black hover:bg-slate-100 py-2" href={"/pexels"}>{"Pexels"}</a>
              <a class="flex justify-center text-base text-black hover:text-black hover:bg-slate-100 py-2" href={"/setting"}>
